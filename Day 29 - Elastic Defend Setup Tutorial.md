...
- **Test Action:**  
    ...
    - Go to RDP session on Windows VM and open a PowerShell console, if you move up with the arrows you should find the command of Invoke-WebRequest and try to download it again. The EDR reacted and deleted it immediately tho
